...
public class ContestEntryExaminers {
    private int id;
    ...
    public ContestEntryExaminers() {
    }

    public ContestEntryExaminers(int contestEntryId, int examinerId, int score, String feedback, Timestamp examDate) {
